...
#ifndef __LIB_TINYXML_H__
#define __LIB_TINYXML_H__
...
//TiXmlNode                // 节点
//TiXmlHandler             // 操作类
class TiXmlDocument;       // 文档
class TiXmlDeclaration;    // 申明，即<?xml version="1.0" encoding="UTF-8"?>
class TiXmlComment;        // 注释
class TiXmlElement;        // 元素
class TiXmlAttribute;      // 元素属性
class TiXmlText;           // 元素值
class TiXmlUnknown;        // 未知
...
public:
    ...
    */
    virtual void ToXML( string &sMsg, int depth ) = 0;
...
public:
    ...
    */
    ...
    const string& ValueTStr() const { return value; }
...
public:
    ...
    */
    ...
    // ToXMLs this Attribute to a FILE stream.
    virtual void ToXML( string &sMsg, int depth );
...
public:
    ...
    */
    ...
    // ToXML the Element to a FILE stream.
    virtual void ToXML( string &sMsg, int depth );
...
public:
    ...
    virtual TiXmlNode* Clone() const;
    // ToXML this declaration to a FILE stream.
    virtual void ToXML( string &sMsg, int depth );
...
public:
    ...
    virtual TiXmlNode* Clone() const;
    // ToXML this Unknown to a FILE stream.
    virtual void ToXML( string &sMsg, int depth );
...
public:
    ...
    */
    ...
    /// ToXML this Document to a FILE stream.
    virtual void ToXML( string &sMsg, int depth=0 );
    // [internal use]
...
public:
    ...
    TiXmlHandle()                   {  }
    void SetHandle( TiXmlNode* _node )                  { this->node = _node; }
