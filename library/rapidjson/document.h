...
// 	char data[32];
// 	sprintf(data,"%d",u);
// 	SetStringRaw(data,internal::StrLen(data));
// 	}

// 	GenericValue(int64_t u) {
// 		char data[32];
// 		sprintf(data,"%ld",u);
// 		SetStringRaw(data,internal::StrLen(data));
// 	}
	...
	*/
	...
	GenericValue& AddMember(const Ch* name, long ldata, Allocator& allocator) {
		Ch cvalue[32];
		sprintf(cvalue,"%ld",ldata);
		GenericValue nvalue(cvalue, internal::StrLen(cvalue), allocator);
		GenericValue n(name, internal::StrLen(name));
		return AddMember(n, nvalue, allocator);
	}

	GenericValue& AddMember(const Ch* name, unsigned long ldata, Allocator& allocator) {
		Ch cvalue[32];
		sprintf(cvalue,"%ld",ldata);
		GenericValue nvalue(cvalue, internal::StrLen(cvalue), allocator);
		GenericValue n(name, internal::StrLen(name));
	...
	GenericValue& AddMember(const Ch* name, int ldata, Allocator& allocator) {
		Ch cvalue[32];
		sprintf(cvalue,"%d",ldata);
		GenericValue nvalue(cvalue, internal::StrLen(cvalue), allocator);
		GenericValue n(name, internal::StrLen(name));
		return AddMember(n, nvalue, allocator);
	}

	GenericValue& AddMember(const Ch* name, const char* data, Allocator& allocator) {
		GenericValue nvalue(data, internal::StrLen(data), allocator);
		GenericValue n(name, internal::StrLen(name));
		return AddMember(n, nvalue, allocator);
	}

	GenericValue& AddMember(const Ch* name, char* data, Allocator& allocator) {
		GenericValue nvalue(data, internal::StrLen(data), allocator);
		GenericValue n(name, internal::StrLen(name));
		return AddMember(n, nvalue, allocator);
	}
