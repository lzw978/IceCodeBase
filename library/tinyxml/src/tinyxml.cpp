...
void TiXmlBase::EncodeString( const string& str, string* outString )
{
    int i=0;
...
void TiXmlElement::ToXML( string &sMsg, int depth )
{
    int i;
...
void TiXmlDocument::ToXML( string &sMsg, int depth )
{
    ...
    if ( useMicrosoftBOM )
    {
        ...
        sMsg += TIXML_UTF_LEAD_1;
        sMsg += TIXML_UTF_LEAD_2;
    }
...
void TiXmlComment::ToXML( string &sMsg, int depth )
{
...
void TiXmlText::ToXML( string &sMsg, int depth )
{
    if ( cdata )
    {
        int i;
...
void TiXmlDeclaration::ToXML( string &sMsg, int depth )
{
    if (1) {
        //fprintf( cfile, "<?xml " );
        sMsg += "<?xml ";
    ...
    //printf("TiXmlDeclaration:sMsg[%s]\n", sMsg.c_str());
}
...
void TiXmlUnknown::ToXML( string &sMsg, int depth )
{
    for ( int i=0; i<depth; i++ ) {
        //fprintf( cfile, "    " );
        sMsg += "    ";
